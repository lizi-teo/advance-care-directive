...
Tracked changes to Australian advance care directive legislation, forms, and requirements.
...
**Action needed:** Yes — manually retrieve the January 2026 SA reform details from the Premier's media release or SA Health (advancecaredirectives.sa.gov.au). Verify whether the current SA ACD form and witness/SDM guidance in the app reflects the new provisions. Check SA Parliament website for the amending act name and commencement date.

**NSW — No confirmed changes:** No new legislation or updated forms detected for 2025–2026. NSW continues to rely on common law ACDs only (no statutory ACD form). NSW Health form and information booklet remains current from December 2023.
**Action needed:** No

**QLD — No confirmed changes:** No major legislative or form changes since November 2020 (Form 4 advance health directive remains current under the Powers of Attorney Act 1998 QLD).
**Action needed:** No
